...
INSERT INTO `settings` (`settingname`, `settingvalue`) VALUES
  ...
  ('email_message', 'Your room has been reserved! Keep this email as proof of your reservation as you may be asked to provide confirmation upon arrival. As a courtesy to other patrons, please cancel your reservation if this room is no longer needed.'),
  ('email_system', ''),
  ('endtime', '17:00'),
