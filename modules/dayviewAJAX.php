...
if ($_SESSION["username"] != "") {
    ...
    //$calendarimg = ("../themes/default/desktop/images/calendarbutt.png");
        ...
        $dvout .= "<span style=\"position: -webkit-sticky; position: sticky; top: 0; z-index: 10; background-color: c4bcc9;\"><input id=\"calendarButton\" type=\"button\" value=\"Show/Hide Calendar\" onclick=\"showHideDiv('calendarDiv')\"/></span></div>";
