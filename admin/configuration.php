...
if (!(isset($_SESSION["username"])) || $_SESSION["username"] == "") {
    ...
    switch ($op) {
        case "instance_name":
            ...
            if ($instance_name != "") {
                if (model\Setting::update("instance_name", $instance_name)) {
        ...
        case "instance_url":
            ...
            if ($instance_url != "") {
                if (model\Setting::update('instance_url', $instance_url)) {
        ...
        case "https":
            ...
            if ($https != "") {
                if (model\Setting::update('https', $https)) {
        ...
        case "email_filter":
            ...
            if ($email_filter != "") {
                ...
                if (model\Setting::update('email_filter', $email_filter)) {
        ...
        case "ldap_baseDN":
            ...
            if ($ldap_baseDN != "") {
                if (model\Setting::update('ldap_baseDN', $ldap_baseDN)) {
        ...
        case "ldap_host":
            ...
            if ($ldap_host != "") {
                if (model\Setting::update('ldap_host', $ldap_host)) {
